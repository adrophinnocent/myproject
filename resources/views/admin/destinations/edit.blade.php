        ...
        <div class="mb-6">
            ...
            <div class="flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-2xl p-8 bg-gray-50 mb-4">
                @if ($destination->featured_image)
                    <img id="dest-preview" src="{{ \Illuminate\Support\Facades\Storage::disk('public')->url($destination->featured_image) }}" alt="{{ $destination->name }}" class="w-full max-w-xs h-32 object-cover rounded-xl mb-4 shadow-md">
                @else
                ...
                <input type="hidden" name="featured_image_path" id="featured_image_path" value="{{ $destination->featured_image }}">
