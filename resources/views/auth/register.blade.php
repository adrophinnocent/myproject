    ...
    <body>
        <div class="container">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Enter your username">
                        </div>
                        <x-input-error :messages="$errors->get('name')" class="validation-error" />
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <x-input-error :messages="$errors->get('password_confirmation')" class="validation-error" />
                    </div>
            ...
            <div class="right-side">
                ...
                <a href="{{ route('login') }}" class="btn btn-outline" style="text-decoration: none; width: 60%; text-align: center; padding: 14px;">
                    <span>Login</span>
                </a>
            </div>
        </div>
