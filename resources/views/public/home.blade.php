...
<section class="py-24 bg-white" x-data="{
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 text-lg mb-4 max-w-2xl mx-auto">Explore our most popular safari packages.</p>
                    ...
                    <div class="snap-start shrink-0 w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)]">
                        <div class="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-md hover:shadow-xl transition-all h-full">
                            <div class="relative h-56">
                                <img src="{{ $tour->featured_image_url }}" width="400" height="224" alt="{{ \App\Helpers\AssetHelper::asString($tour->title) }}" class="w-full h-full object-cover" loading="lazy">
                            </div>
