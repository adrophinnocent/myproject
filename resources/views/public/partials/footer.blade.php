        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="space-y-6">
                <a href="{{ route('home') }}" class="flex items-center gap-3 group">
                    @if($footerLogo)
                        <img src="{{ asset('storage/' . $footerLogo) }}" alt="{{ $siteName }}" class="h-12 w-auto object-contain">
                    @elseif($logo)
                        <img src="{{ asset('storage/' . $logo) }}" alt="{{ $siteName }}" class="h-12 w-auto object-contain">
                    @else
